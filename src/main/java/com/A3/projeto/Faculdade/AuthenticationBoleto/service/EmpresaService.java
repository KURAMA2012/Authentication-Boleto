...
public class EmpresaService {
    ...
    public EmpresaResponse salvar(EmpresaRequest request) {
        ...
        return new EmpresaResponse(salva.getId(), salva.getNome(), salva.getCnpj(), salva.getEmailContato(), salva.getTelefone());
    }
    ...
    public EmpresaResponse buscarResponsePorCnpj(String cnpj) {
        ...
        return new EmpresaResponse(empresa.getId(), empresa.getNome(), empresa.getCnpj(), empresa.getEmailContato(), empresa.getTelefone());
    }
