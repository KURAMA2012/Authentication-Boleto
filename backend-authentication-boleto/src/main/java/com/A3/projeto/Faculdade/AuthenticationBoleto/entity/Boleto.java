...
public class Boleto {
	...
	@Column(name = "tf_numero_pagador")
	private String telefoneCelularPagador;
	...
	public String getTelefoneCelularPagador() {
		return telefoneCelularPagador;
	}

	public void setTelefoneCelularPagador(String telefoneCelularPagador) {
		this.telefoneCelularPagador = telefoneCelularPagador;
	}
